            ...
            >
                <div className="flex flex-col">
                    ...
                    <nav className="space-y-1 px-2">
                        <NavItem href="/dashboard" label="Overview" active={isActive('/dashboard')} collapsed={isCollapsed} />
                        ...
                        <NavItem href="/chat" label="Chat" active={isActive('/chat')} collapsed={isCollapsed} />
                        <NavItem href="/invoices" label="Invoices" active={isActive('/invoices')} collapsed={isCollapsed} />
