...
export const translations = {
    fr: {
        ...
        calculator: {
            ...
            subtitle: "Découvrez combien votre clinique pourrait économiser en réduisant les absences avec Mia.",
            inputsTitle: "Paramètres de votre clinique",
            doctors: "Nombre de médecins",
            visitsPerYear: "Visites par médecin par an",
            noShowRate: "Taux d'absence (en %)",
            costPerNoShow: "Coût par absence (en $)",
            assumptions: "Hypothèses fixes",
            operatingWeeks: "Semaines d'exploitation",
            perYear: "/an",
            miaReduction: "Réduction des absences par Mia",
            perClinicPerYear: "par clinique par an",
            withoutMia: "Sans Mia",
            withMia: "Avec Mia",
            totalAnnualVisits: "Visites annuelles totales",
            totalNoShows: "Total des absences",
            annualRevenueLost: "Revenus annuels perdus aux absences",
            wastedHours: "Heures de praticien gaspillées",
            assumingMin: "en supposant des rendez-vous de 30 min",
            noShowsPrevented: "Absences évitées",
            revenueRecovered: "Revenus récupérés",
            hoursReclaimed: "Heures de praticien récupérées",
            scenarioLabel: "Scénario de réduction",
            conservative: "Conservateur",
            projected: "Projeté",
            optimistic: "Optimiste",
            backToHome: "Retour à l'accueil",
            ctaTitle: "Prêt à récupérer ces revenus?",
    ...
    en: {
        ...
        calculator: {
            ...
            subtitle: "Discover how much your clinic could save by reducing no-shows with Mia.",
            inputsTitle: "Your clinic parameters",
            doctors: "Number of doctors",
            visitsPerYear: "Visits per doctor per year",
            noShowRate: "No-show rate (in %)",
            costPerNoShow: "Cost per no-show (in $)",
            assumptions: "Fixed assumptions",
            operatingWeeks: "Operating weeks",
            perYear: "/year",
            miaReduction: "Mia's no-show reduction",
            perClinicPerYear: "per clinic per year",
            withoutMia: "Without Mia",
            withMia: "With Mia",
            totalAnnualVisits: "Total annual visits",
            totalNoShows: "Total no-shows",
            annualRevenueLost: "Annual revenue lost to no-shows",
            wastedHours: "Wasted practitioner hours",
            assumingMin: "assuming 30min appointments",
            noShowsPrevented: "No-shows prevented",
            revenueRecovered: "Revenue recovered",
            hoursReclaimed: "Practitioner hours reclaimed",
            scenarioLabel: "Reduction scenario",
            conservative: "Conservative",
            projected: "Projected",
            optimistic: "Optimistic",
            backToHome: "Back to home",
            ctaTitle: "Ready to recover this revenue?",
